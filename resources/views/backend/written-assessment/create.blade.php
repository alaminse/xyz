...
@section('content')
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="{{ route('admin.writtenassessments.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <label for="question" class="form-label">Question <span
                                    class="required text-danger">*</span></label>
                            <textarea class="form-control summernote" name="question" cols="30" rows="2" required>{!! old('question') !!}</textarea>
                        </div>
                        <div class="col-sm-12 mb-2">
                            <label for="answer" class="form-label">Answer <span
                                    class="required text-danger">*</span></label>
                            <textarea class="form-control summernote" name="answer" cols="30" rows="5" required>{!! old('answer') !!}</textarea>
                        </div>
                    </div>
