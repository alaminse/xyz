    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    <a class="btn btn-warning text-white" href="{{ route('admin.lessons.index') }}">Back</a>
                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="2" {{ $lesson->status == 2 ? 'selected' : '' }}>Inactive</option>
                                    <option value="3" {{ $lesson->status == 3 ? 'selected' : '' }}>Deleted</option>
                                </select>
                            </div>
                        </div>
                    </div>
