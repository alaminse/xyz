                ...
                <div class="x_panel">
                    <div class="x_title d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.flashs.edit', $flash->id) }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i> Edit
                            </a>
                            <a href="{{ route('admin.flashs.index') }}" class="btn btn-warning btn-sm text-white">
                    ...
                    <div class="x_content">
                                ...
                                <div class="card meta-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        @forelse($flash->courses as $course)
                                            <span class="badge badge-primary badge-course">{{ $course->name }}</span>
                                        @empty
                            ...
                            <div class="col-md-3">
                                <div class="card meta-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-0 font-weight-bold">{{ $flash->chapter?->name ?? 'N/A' }}</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="card meta-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-0 font-weight-bold">{{ $flash->lesson?->name ?? 'N/A' }}</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="card meta-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-0 font-weight-bold">{{ $flash->questions->count() }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                @forelse($flash->questions as $index => $question)
