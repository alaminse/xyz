            ...
            <form action="{{ route('admin.notices.update', $notice->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-12 mb-3">
                        ...
                        <textarea class="form-control summernote" name="message" rows="4" required>{!! old('message', $notice->message) !!}</textarea>
                        @error('message')
                    ...
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        <select name="type" class="form-control" required>
                            ...
                            <option value="urgent" {{ old('type', $notice->type) == 'urgent' ? 'selected' : '' }}>Urgent (red)</option>
                        </select>
                    </div>
