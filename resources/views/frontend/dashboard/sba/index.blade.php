                                        ...
                                        <ul class="list-group">
                                            @forelse ($chapter->lessons as $lesson)
                                                <li class="list-group-item">
                                                    <a
                                                        href="{{ route('sbas.test', ['course' => $course->slug, 'chapter' => $chapter->slug, 'lesson' => $lesson->slug]) }}">
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                <div
                                    ...
                                    <a href="{{ route('sbas.review', $item->slug) }}"
                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated {{ $progressItemClass }}"
                                        ...
                                        {{ number_format($progressItem, 0) }}% ({{ $item->correct }}/{{ $item->total }})
                                    </div>
                                </div>
                            </div>
                        </div>
