<?php $__env->startSection('title', 'User Progress - ' . $assessment->name); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="mb-2">
                        <i class="fa fa-trophy"></i> <?php echo e($assessment->name); ?>

                    </h2>
                    <p class="mb-0">
                        <i class="fa fa-star"></i> মোট নম্বর: <strong><?php echo e($assessment->total_marks); ?></strong> |
                        <i class="fa fa-clock-o"></i> সময়: <strong><?php echo e($assessment->time); ?> মিনিট</strong> |
                        <i class="fa fa-users"></i> অংশগ্রহণকারী: <strong><?php echo e($totalParticipants); ?></strong>
                    </p>
                </div>
                <div class="col-md-4 text-right">
                    <a href="<?php echo e(route('admin.assessments.index')); ?>" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-9 text-right">
                                ...
                                <h3 class="mb-0 font-weight-bold"><?php echo e($totalParticipants); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-9 text-right">
                                ...
                                <h3 class="mb-0 font-weight-bold"><?php echo e($passedCount); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-9 text-right">
                                ...
                                <h3 class="mb-0 font-weight-bold">
                                    <?php echo e($totalParticipants > 0 ? round(($passedCount / $totalParticipants) * 100, 1) : 0); ?>%
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-9 text-right">
                                ...
                                <h3 class="mb-0 font-weight-bold">
                                    <?php echo e($leaderboard->max('achive_marks') ?? 0); ?>
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="text-primary font-weight-bold">
                            <?php echo e($leaderboard->count() > 0 ? round($leaderboard->avg('achive_marks'), 2) : 0); ?>

                        </h3>
                        <small class="text-muted"><?php echo e($assessment->total_marks); ?> এর মধ্যে</small>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="text-warning font-weight-bold">
                            <?php echo e($assessment->total_marks * 0.7); ?>
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="text-danger font-weight-bold">
                            <?php echo e($leaderboard->min('achive_marks') ?? 0); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card winner-card shadow-sm h-100">
                                            ...
                                            <div class="card-body text-center pt-4">
                                                <div class="mb-3">
                                                    <?php if(isset($winner->user->profile_photo_path) && $winner->user->profile_photo_path): ?>
                                                        <img src="<?php echo e(asset('storage/' . $winner->user->profile_photo_path)); ?>"
                                                            alt="<?php echo e($winner->user->name); ?>" class="user-avatar-medium">
                                                    <?php else: ?>
                                                        <div class="avatar-placeholder user-avatar-medium d-inline-flex">
                                                            <?php echo e(strtoupper(substr($winner->user->name, 0, 1))); ?>

                                                        </div>
                                                    <?php endif; ?>
                                                </div>

                                                <span class="rank-badge rank-<?php echo e($loop->iteration); ?> mb-2">
                                                    #<?php echo e($loop->iteration); ?>

                                                </span>

                                                <h5 class="mt-2 mb-1"><?php echo e($winner->user->name); ?></h5>
                                                <p class="text-muted small mb-2"><?php echo e($winner->user->email); ?></p>

                                                <div class="mt-3">
                                                    <h4 class="text-primary font-weight-bold mb-0">
                                                        <?php echo e($winner->achive_marks); ?> / <?php echo e($assessment->total_marks); ?>

                                                    </h4>
                                                    <p class="text-muted mb-0">
                                                        <span
                                                            class="percentage-badge <?php echo e($winner->percentage >= 70 ? 'pass-badge' : 'fail-badge'); ?>">
                                                            <?php echo e($winner->percentage); ?>%
                                                        </span>
                                                    </p>
                                                </div>
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    <?php echo e($winner->created_at ? $winner->created_at->format('d M Y, h:i A') : 'N/A'); ?>
                        ...
                        <?php if($leaderboard->count() > 0): ?>
                            <div class="table-responsive">
                                <table id="leaderboardTable" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $progress): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="<?php echo e($progress->user_id == auth()->id() ? 'highlight-row' : ''); ?>">
                                                <td>
                                                    <span
                                                        class="rank-badge <?php echo e($progress->rank <= 3 ? 'rank-' . $progress->rank : ''); ?>">
                                                        #<?php echo e($progress->rank); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php if(isset($progress->user->profile_photo_path) && $progress->user->profile_photo_path): ?>
                                                            <img src="<?php echo e(asset('storage/' . $progress->user->profile_photo_path)); ?>"
                                                                alt="<?php echo e($progress->user->name); ?>"
                                                                class="user-avatar-small mr-2">
                                                        <?php else: ?>
                                                            <div class="avatar-placeholder user-avatar-small mr-2">
                                                                <?php echo e(strtoupper(substr($progress->user->name, 0, 1))); ?>
                                                ...
                                                <td><?php echo e($progress->user->email); ?></td>
                                                <td class="text-center">
                                                    <strong class="text-primary"><?php echo e($progress->achive_marks); ?></strong>
                                                </td>
                                                <td class="text-center"><?php echo e($assessment->total_marks); ?></td>
                                                <td class="text-center">
                                                    <span
                                                        class="percentage-badge <?php echo e($progress->percentage >= 70 ? 'pass-badge' : 'fail-badge'); ?>">
                                                        <?php echo e($progress->percentage); ?>%
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <?php if($progress->achive_marks >= $assessment->total_marks * 0.7): ?>
                                                ...
                                                <td class="text-center">
                                                    <small>
                                                        <?php echo e($progress->created_at ? $progress->created_at->format('d M Y, h:i A') : 'N/A'); ?></small><br>
                                                    <small
                                                        class="text-muted"><?php echo e($progress->created_at ? $progress->created_at->format('h:i A') : 'N/A'); ?></small>
                                                </td>
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="<?php echo e(route('admin.assessments.user-details', $progress->id)); ?>"
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/assessment/leaderboard.blade.php ENDPATH**/ ?>