<?php $__env->startSection('title', 'SBA'); ?>
                                        ...
                                        <ul class="list-group">
                                            <?php $__empty_2 = true; $__currentLoopData = $chapter->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <li class="list-group-item">
                                                    <a
                                                        href="<?php echo e(route('sbas.test', ['course' => $course->slug, 'chapter' => $chapter->slug, 'lesson' => $lesson->slug])); ?>">
        ...
        <div class="col-sm-12 col-md-6 col-lg-7 mb-3">
            <div class="card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px;">
                <div class="card-body">
                            ...
                            <div class="card-body">
                                <div
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-2 mb-md-0 bg-transparent">
                                    ...
                                    <!-- Full width on xs + sm, auto on md+ -->
                                    <a href="<?php echo e(route('sbas.review', $item->slug)); ?>"
                                        class="btn btn-sm button-yellow w-md-auto">
                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo e($progressItemClass); ?>"
                                        role="progressbar" style="width: <?php echo e($progressItem); ?>%;"
                                        aria-valuenow="<?php echo e($progressItem); ?>" aria-valuemin="0" aria-valuemax="100">
                                        <?php echo e(number_format($progressItem, 0)); ?>% (<?php echo e($item->correct); ?>/<?php echo e($item->total); ?>)
                                    </div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle me-2"></i>No progress yet. Start practicing to see your results
                            here!
                        </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('frontend.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/frontend/dashboard/sba/index.blade.php ENDPATH**/ ?>