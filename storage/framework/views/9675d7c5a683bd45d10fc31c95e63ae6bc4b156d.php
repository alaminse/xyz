...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        <select name="type" class="form-control" required>
                            <option value="info" <?php echo e(old('type') == 'info' ? 'selected' : ''); ?>>Info (blue)</option>
                            <option value="warning" <?php echo e(old('type') == 'warning' ? 'selected' : ''); ?>>Warning (yellow)</option>
                            <option value="urgent" <?php echo e(old('type') == 'urgent' ? 'selected' : ''); ?>>Urgent (red)</option>
                        </select>
                    </div>

                    <div class="col-sm-12 col-md-4 mb-3">
                        <label for="start_at" class="form-label">Start At (optional)</label>
                        <input type="datetime-local" class="form-control" name="start_at" value="<?php echo e(old('start_at')); ?>">
                    </div>

                    <div class="col-sm-12 col-md-4 mb-3">
                        <label for="end_at" class="form-label">End At (optional)</label>
                        <input type="datetime-local" class="form-control" name="end_at" value="<?php echo e(old('end_at')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/notice/create.blade.php ENDPATH**/ ?>