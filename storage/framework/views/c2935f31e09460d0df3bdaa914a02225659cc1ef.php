...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="<?php echo e(route('admin.ospestations.update', $ospe->id)); ?>" method="POST"
                            ...
                            <select name="course_ids[]" id="courseSelect" class="form-control select2" multiple required>
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        <?php echo e($ospe->courses->contains($course->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            ...
                            <select name="chapter_id" id="chapterSelect" required class="select2 form-control"
                                data-old-value="<?php echo e(old('chapter_id', $ospe->chapter_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            ...
                            <select name="lesson_id" id="lessonSelect" class="select2 form-control" required
                                data-old-value="<?php echo e(old('lesson_id', $ospe->lesson_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <select name="status" class="form-control select2">
                                <option value="0" <?php echo e(old('status', $ospe->status) == '0' ? 'selected' : ''); ?>>Pending
                                </option>
                                <option value="1" <?php echo e(old('status', $ospe->status) == '1' ? 'selected' : ''); ?>>Active
                                </option>
                                <option value="2" <?php echo e(old('status', $ospe->status) == '2' ? 'selected' : ''); ?>>Inactive
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3 mt-4">
                            ...
                            <input type="checkbox" name="isPaid" value="1"
                                <?php echo e(old('isPaid', $ospe->isPaid) ? 'checked' : ''); ?>>
                        </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/ospe-station/edit.blade.php ENDPATH**/ ?>