<?php $__env->startSection('title', 'Assessment Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="<?php echo e(route('admin.assessments.update', $assessment_course->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <select name="course_ids[]" id="courseSelect" class="form-control select2" multiple required>
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        <?php echo e(in_array($course->id, old('course_ids', $course_ids ?? [])) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <select name="chapter_id" id="chapterSelect" required class="select2 form-control"
                                    data-old-value="<?php echo e(old('chapter_id', $assessment_course->chapter_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <select name="lesson_id" id="lessonSelect" class="select2 form-control" required
                                    data-old-value="<?php echo e(old('lesson_id', $assessment_course->lesson_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter assessment name"
                                value="<?php echo e(old('name', $assessment_course->name)); ?>">
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <input type="number" name="time" class="form-control" placeholder="60"
                                value="<?php echo e(old('time', $assessment_course->time)); ?>">
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <select name="status" class="select2 form-control">
                                <option value="1" <?php echo e(old('status', $assessment_course->status) == 1 ? 'selected' : ''); ?>>Active</option>
                                <option value="2" <?php echo e(old('status', $assessment_course->status) == 2 ? 'selected' : ''); ?>>Inactive</option>
                                <option value="3" <?php echo e(old('status', $assessment_course->status) == 3 ? 'selected' : ''); ?>>Delete</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <input type="datetime-local" name="start_date_time" class="form-control"
                                value="<?php echo e(old('start_date_time', $assessment_course->start_date_time)); ?>">
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <input type="datetime-local" name="end_date_time" class="form-control"
                                value="<?php echo e(old('end_date_time', $assessment_course->end_date_time)); ?>">
                        </div>
                            ...
                            <div class="mt-2">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" name="isPaid" id="isPaid" value="1"
                                        <?php echo e(old('isPaid', $assessment_course->isPaid) == 1 ? 'checked' : ''); ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <a href="<?php echo e(route('admin.assessments.index')); ?>" class="btn btn-secondary ml-2">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                let questionIndex = '<?php echo e(count($questions)); ?>';
                ...
                const courseIds = <?php echo json_encode(old('course_ids', $assessment_course->courses->pluck('id')), 512) ?>;
                const chapterId = '<?php echo e(old("chapter_id", $assessment_course->chapter_id)); ?>';
                const lessonId = '<?php echo e(old("lesson_id", $assessment_course->lesson_id)); ?>';
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/assessment/edit.blade.php ENDPATH**/ ?>