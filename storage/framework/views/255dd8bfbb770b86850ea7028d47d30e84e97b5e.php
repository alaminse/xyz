<div class="sidebar-container">
    <div class="logo-box">
        <a href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('uploads/logo/logo.png')); ?>" alt="Logo">
        </a>
    </div>
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item <?php echo e(request()->is('enrollments') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('enrollments')); ?>">
                <i class="bx bx-book me-2"></i> Enrolled Courses
            </a>
        </li>

        
        <li class="nav-item <?php echo e(request()->is('all.courses') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('all.courses')); ?>">
        ...
        <?php $__currentLoopData = enrolled_courses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li class="nav-item <?php echo e($isExpanded ? 'active' : ''); ?>">
                <a class="nav-link <?php echo e($isExpanded ? '' : 'collapsed'); ?>" data-bs-toggle="collapse"
                    href="#course-<?php echo e($item['slug']); ?>" aria-expanded="<?php echo e($isExpanded ? 'true' : 'false'); ?>">
                ...
                <ul class="collapse <?php echo e($isExpanded ? 'show' : ''); ?>" id="course-<?php echo e($item['slug']); ?>">
                    ...
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routeKey => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!($item[$module['enabled']] ?? false)) continue; ?>

                        <?php if(!empty($module['group'])): ?>
                            <div class="submenu-title"><?php echo e($module['group']); ?></div>
                        <?php endif; ?>

                        <li class="nav-item">
                            <a class="nav-link dropdown-item
                            <?php echo e(request()->routeIs($routeKey . '.*') && $isCurrentCourse ? 'active' : ''); ?>"
                                href="<?php echo e(route($module['route'], $item['slug'])); ?>">
                                <i class="bx <?php echo e($module['icon']); ?> me-2"></i>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/frontend/includes/sidebar.blade.php ENDPATH**/ ?>