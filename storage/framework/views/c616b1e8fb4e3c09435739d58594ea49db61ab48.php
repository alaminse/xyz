<?php $__env->startSection('title', 'Flash Card Test'); ?>

<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/flash.css')); ?>">
            ...
            <div class="card-body p-1 p-sm-1">
                <div
                            ...
                            <div class="nav-buttons">
                                ...
                                <h6 class="mb-0">
                                    Q <span id="currentQ">1</span> of <span id="totalQ">
                                        <?php echo e(count($remainingQuestionIds) > 0 ? count($remainingQuestionIds) : $totalOriginalQuestions); ?>
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('flashs.index', ['course' => $courseSlug])); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                ...
                <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flashcard-form" data-index="<?php echo e($index); ?>" data-id="<?php echo e($question->id); ?>"
                        ...
                        <div class="flashcard-container">
                            ...
                            <div class="answer-section" style="display:none">
                                <h6>Answer:</h6>
                                <div class="answer-content"><?php echo $question->answer; ?></div>
                ...
                <div class="progress-card">
                    ...
                    <div class="mb-3">
                        <p>
                            ...
                            Correct: <strong id="correctCount"><?php echo e($quiz->correct ?? 0); ?> /
                                <?php echo e($totalOriginalQuestions); ?></strong>
                        </p>
                        <p>
                            <i class="bi bi-layers"></i>
                            Remaining: <strong id="remainingCount"><?php echo e(count($remainingQuestionIds)); ?></strong>
                        </p>
                        <p>
                    ...
                    <a href="<?php echo e(route('flashs.index', ['course' => $courseSlug])); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(function() {
                ...
                let current = 0;
                let correct = <?php echo e($quiz->correct ?? 0); ?>;
                let wrong = <?php echo e($quiz->wrong ?? 0); ?>;
                let maxVisited = 0;
                let questionQueue = [];

                // Load existing answers - FIXED: Handle new data structure
                let answersData = <?php echo json_encode(json_decode($quiz->answers ?? '[]', true) ?? []); ?>;
                ...
                let savedQueue = <?php echo json_encode(json_decode($quiz->question_queue ?? '[]', true) ?? []); ?>;
                let remainingIds = <?php echo json_encode($remainingQuestionIds ?? []); ?>;
                let repeatQueueIds = <?php echo json_encode($repeatQueueIds ?? []); ?>;
        ...
        `;
                ...
                $('.rateBtn').click(function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('flashs.updateProgress')); ?>",
                        method: 'POST',
                        data: {
        ...
        `;
                ...
                if (questionQueue.length > 0) {
                    ...
                    window.location.href = "<?php echo e(route('flashs.index', ['course' => $courseSlug])); ?>";
                }
...
<?php echo $__env->make('frontend.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/frontend/dashboard/flash/test.blade.php ENDPATH**/ ?>