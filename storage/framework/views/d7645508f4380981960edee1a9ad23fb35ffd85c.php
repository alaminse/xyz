<?php $__env->startSection('title', 'Mcqs'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('warning')): ?>
        ...
        <?php if(session('skipped')): ?>
            <table class="table table-bordered table-sm">
                <thead><tr><th>Reason</th><th>Count</th><th>Example Rows</th></tr></thead>
                <tbody>
                    <?php $__currentLoopData = session('skipped'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($reason); ?></td>
                            <td><?php echo e($info['count']); ?></td>
                            <td><?php echo e(implode(', ', $info['rows'])); ?><?php echo e($info['count'] > 5 ? ' ...' : ''); ?></td>
                        </tr>
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <a class="btn btn-sm btn-success text-light" href="<?php echo e(route('admin.mcqs.create')); ?>"><i
                                class="fa fa-plus"></i>
                            Add New</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="btn btn-sm btn-secondary text-light" href="<?php echo e(route('admin.mcqs.sample-download')); ?>">
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('admin.mcqs.bulk-upload.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <small class="text-muted">
                                ...
                                <a href="<?php echo e(route('admin.mcqs.sample-download')); ?>">Download sample</a>
                            </small>
                        </div>
                    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            $('#exportCourse').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.mcqs.export.chapters')); ?>",
                    method: 'GET',
                    data: {
                        course_id: courseId
                    },
            ...
            $('#exportChapter').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.mcqs.export.lessons')); ?>",
                    method: 'GET',
                    data: {
            ...
            $('#exportSubmitBtn').on('click', function() {
                ...
                let url = "<?php echo e(route('admin.mcqs.export')); ?>" + "?";
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/mcq/index.blade.php ENDPATH**/ ?>