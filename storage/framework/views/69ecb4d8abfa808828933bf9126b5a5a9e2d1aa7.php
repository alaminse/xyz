...
<?php $__env->startSection('title', 'Mock Viva Lists'); ?>
...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      <div class="x_title">
        <h2>Mock Viva Lists <small></small></h2>
        <ul class="nav navbar-right panel_toolbox">
          <li><a class="btn btn-sm btn-success text-white" href="<?php echo e(route('admin.mockvivas.create')); ?>"><i class="fa fa-plus"></i> Add New</a>
          </li>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/mockviva/index.blade.php ENDPATH**/ ?>