<?php $__env->startSection('title', 'Mock Viva'); ?>
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <?php $__currentLoopData = $topic->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="list-group-item">
                                                            <a href="<?php echo e(route('mockvivas.test', ['course' => $course->slug, 'chapter' => $topic->slug, 'lesson' => $lesson->slug])); ?>"><?php echo e($lesson->name); ?></a>
                                                        </li>
...
<?php echo $__env->make('frontend.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/frontend/dashboard/mock-viva/index.blade.php ENDPATH**/ ?>