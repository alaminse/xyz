<?php $__env->startSection('title', 'Ospe Station Details'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="x_panel">
            <div class="x_title d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('admin.ospestations.index')); ?>" class="btn btn-sm btn-success">Back to List</a>
                </div>
            </div>
            <div class="x_content pt-4">
                <div class="mockviva-details mb-4 p-3 border rounded bg-white shadow-sm">
                    <div class="row text-dark">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0">
                                <?php $__currentLoopData = $ospe->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0"><?php echo e($ospe->chapter->name ?? 'N/A'); ?></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <h5 class="mb-1 fw-bold">Lesson</h5>
                            <p class="mb-0"><?php echo e($ospe->lesson->name ?? 'N/A'); ?></p>
                        </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $ospe->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupIndex => $questionGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="question-group-card">
                        <div class="group-actions">
                            <button type="button" class="btn btn-sm btn-warning edit-group-btn"
                                data-id="<?php echo e($questionGroup->id); ?>" data-questions='<?php echo json_encode($questions, 15, 512) ?>'
                                data-image="<?php echo e($questionGroup->image); ?>">
                                <i class="fa fa-edit"></i> Edit
                            </button>
                            <button type="button" class="btn btn-sm btn-danger delete-group-btn"
                                data-id="<?php echo e($questionGroup->id); ?>" data-title="<?php echo e($questionGroup->title); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-8">
                                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qIndex => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="qa-item">
                                                <div class="question-text">Q<?php echo e($qIndex + 1); ?>:
                                                    <?php echo $q['question'] ?? 'N/A'; ?></div>
                                                <div class="answer-text">Answer: <?php echo $q['answer'] ?? 'N/A'; ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <?php if($questionGroup->image): ?>
                                            <img src="<?php echo e(asset('uploads/' . $questionGroup->image)); ?>" alt="OSPE Image"
                                                class="img-thumbnail"
    ...
    <div class="modal fade" id="addQuestionGroupModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.ospestations.questions.store', $ospe->id)); ?>" method="POST"
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            const ospeCourseIds = <?php echo json_encode($ospe->courses->pluck('id')->toArray(), 15, 512) ?>;
            const ospeChapterId = <?php echo e($ospe->chapter_id ?? 'null'); ?>;
            const ospeLessonId = <?php echo e($ospe->lesson_id ?? 'null'); ?>;
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/ospe-station/show.blade.php ENDPATH**/ ?>