                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <label for="question" class="form-label">Question <span
                                    class="required text-danger">*</span></label>
                            <textarea class="form-control summernote" name="question" cols="30" rows="2" required><?php echo e(old('question', $written->question)); ?></textarea>
                        </div>
                        <div class="col-sm-12 mb-2">
                            <label for="answer" class="form-label">Answer <span
                                    class="required text-danger">*</span></label>
                            <textarea class="form-control summernote" name="answer" cols="30" rows="5" required><?php echo old('answer', $written->answer); ?></textarea>
                        </div>
                        <div class="col-sm-12 col-md-6 mb-2">
