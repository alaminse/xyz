<?php $__env->startSection('title', 'Self Assessment'); ?>
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <a class="btn btn-sm btn-success text-light" href="<?php echo e(route('admin.assessments.create')); ?>"><i class="fa fa-plus"></i>
                            Add New</a>
                    </li>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            function getAssessments(slug) {
                $.ajax({
                    url: '/admin/assessments/get/data',
                    data: { slug: slug },
                    method: 'GET',
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/assessment/index.blade.php ENDPATH**/ ?>