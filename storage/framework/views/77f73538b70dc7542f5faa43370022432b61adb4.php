...
<div class="x_panel">
    ...
    <div class="x_content">
        <form action="<?php echo e(route('admin.settings.privacy.update', $privacy->id ?? null)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control summernote" name="description" cols="30" rows="5"><?php echo e(old('description', $privacy->value ?? '')); ?></textarea>
                </div>
                <div class="col-12">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medimaniac/resources/views/backend/settings/privacy.blade.php ENDPATH**/ ?>