        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="btn btn-warning text-white" href="<?php echo e(route('admin.notes.index')); ?>"> Back</a>
                    </li>
                    ...
                    <div class="row">
                            ...
                            <select name="course_ids[]" id="courseSelect" class="form-control select2" multiple required>
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"
                                        <?php echo e((collect(old('course_ids', $note->courses->pluck('id')))->contains($course->id)) ? 'selected' : ''); ?>>
                        ...
                        <div class="col-sm-12 mb-2">
                            ...
                            <input class="form-control" id="title" name="title" placeholder="Enter Note title"
                                value="<?php echo e(old('title', $note->title)); ?>" required />
                        </div>
                        <div class="col-sm-12 mb-2">
                            <label for="description" class="form-label">Description <span
                                    class="required text-danger">*</span></label>
                            <textarea class="form-control summernote" name="description" cols="30" rows="5" required><?php echo old('description', $note->description); ?></textarea>
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="3" <?php echo e($note->status == 3 ? 'selected' : ''); ?>>Deleted</option>
                            </select>
                        </div>
                    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                const courseIds = <?php echo json_encode(old('course_ids', $note->courses->pluck('id')), 512) ?>;
                const chapterId = '<?php echo e(old("chapter_id", $note->chapter_id)); ?>';
                const lessonId = '<?php echo e(old("lesson_id", $note->lesson_id)); ?>';
