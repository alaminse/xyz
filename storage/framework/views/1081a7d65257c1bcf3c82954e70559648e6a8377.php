...
<div class="col-md-12 col-sm-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="<?php echo e(route('admin.notes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-12 col-md-6 mb-3">
                        ...
                        <select name="lesson_id" id="lessonSelect" class="form-control select2">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="alert alert-info">
                    ...
                    After creating this note, you'll be taken to its page where you can add
                    one or more sections (title + content).
                </div>
